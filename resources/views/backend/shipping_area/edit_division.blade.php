    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Division Page</li>
            </ol>
        </nav>
...
<div class="col-lg-12" bis_skin_checked="1">
    <div class="card" bis_skin_checked="1">
        <div class="card-body" bis_skin_checked="1">
            ...
            <form action="{{route('update.division')}}" id ="myForm" method="post">
                @csrf
                   <input type="hidden" name="division_id" value="{{$divi->id}}">
                ...
                <div class="col-sm-9 text-secondary form-group" bis_skin_checked="1">
                    <input type="text" name="division_name" class="form-control" value="{{$divi->division_name}}">
