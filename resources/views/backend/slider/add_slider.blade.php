...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add Slider Page</li>
            </ol>
        </nav>
    ...
    <div class="ms-auto">
        <div class="btn-group">
            <a href="{{route('show.all.slider')}}" class="btn btn-primary"> All Slide</a>
        </div>
	</div>
</div>
<div class="col-lg-12" bis_skin_checked="1">
    <div class="card" bis_skin_checked="1">
        <div class="card-body" bis_skin_checked="1">
            ...
            <form action="{{route('store.slider')}}" id ="myForm" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-sm-9 text-secondary form-group" bis_skin_checked="1">
                    <input type="text" name="slider_title" class="form-control" value="">
                ...
                <div class="col-sm-9 text-secondary form-group" bis_skin_checked="1">
                    <input type="text" name="slider_short_title" class="form-control" value="">
