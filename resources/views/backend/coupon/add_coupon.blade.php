...
<div class="col-lg-12" bis_skin_checked="1">
    <div class="card" bis_skin_checked="1">
        <div class="card-body" bis_skin_checked="1">
            ...
            <form action="{{route('store.coupon')}}" id ="myForm" method="post">
                @csrf
                ...
                <div class="col-sm-9 text-secondary form-group" bis_skin_checked="1">
                    <input type="text" name="coupon_name" class="form-control" value="">
                ...
                <div class="col-sm-9 text-secondary form-group" bis_skin_checked="1">
                    <input type="text" name="coupon_discount" class="form-control" value="">
                </div>
              </div>
                <div class="row mb-3" bis_skin_checked="1">
                <div class="col-sm-3" bis_skin_checked="1">
                ...
                <div class="col-sm-9 text-secondary form-group" bis_skin_checked="1">
                    <input type="date" name="coupon_validity" class="form-control" value="">
                </div>
              </div>
