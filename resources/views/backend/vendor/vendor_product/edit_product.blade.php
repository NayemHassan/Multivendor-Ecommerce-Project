...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    ...
                    <div class="ms-auto">
						<div class="btn-group">
							<a href="{{route('add.vendor.product')}}" class="btn btn-primary" >
							All Product List
							</a>
						</div>
					</div>
...
<div class="page-content">
              <div class="card">
				  <div class="card-body p-4">
					  <h5 class="card-title">Edit Vendor Product Thumbnail</h5>
                      <hr>
					
					  <form action="{{route('update.vendor.product.thumbnail')}}" id ="myForm" method="post" enctype="multipart/form-data">
                       @csrf
...
<div class="page-content">            
            ...
            <div class="card-body">
                <table class="table mb-0">
                    ...
                    <tbody>
                    <form action="{{route('update.vendor.product.multiimage')}}" id ="myForm" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <tr>  
                            ...
                            <td>
                                <a href="{{route('vendor.product.multiimage.delete',$img->id)}}" id="delete" class="btn btn-sm btn-danger">Delete</a>
                           </td>   
                        </tr>
                        @endforeach
                        </form>	
