    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Brand Edit Page</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="card" bis_skin_checked="1">
        <div class="card-body" bis_skin_checked="1">
            ...
            <form action="{{route('update.brand',$editData->id)}}" method="post" enctype="multipart/form-data">
               @csrf
                ...
                <div class="col-sm-9 text-secondary" bis_skin_checked="1">
                    <input type="text" name="brand_name" class="form-control" value="{{$editData->brand_name}}">
                </div>
            </div>
            ...
            <div class="row mb-3" bis_skin_checked="1">
                ...
                <div class="col-sm-9 text-secondary" bis_skin_checked="1">
                <img id="showImage" src="{{asset('admin_upload/brand_image/'.$editData->brand_image)}}" width="120" height="120" alt="profile">
                </div>
            </div>
