                            ...
                            <div class="col-md-3">
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="password-change-tab" data-bs-toggle="tab" href="#password-change" role="tab" aria-controls="password-change" aria-selected="true"><i class="fi-rs-user mr-10"></i>Password Change</a>
                                        </li>
                                        <li class="nav-item">
