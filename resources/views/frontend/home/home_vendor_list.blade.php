...
<div class="container">
      ...
      <div class="section-title wow animate__animated animate__fadeIn" data-wow-delay="0">
                    ...
                    <a class="show-all" href="{{route('all.vendor.list')}}">
                        All Vendors
                            ...
                            <div class="vendor-img-action-wrap">
                                <div class="vendor-img">
                                    <a href="{{route('vendor.details',$vendor->id)}}">
                                        <img class="default-img" src="{{(!empty($vendor->photo))?url('vendor_upload/'.$vendor->photo):url('admin_upload/no_image.jpg')}}" height="150px" width="150px" alt="" />
                                    </a>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-end mb-30">
                                    <div>
                                        ...
                                        <div class="product-rate-cover">
                                            @php
                             $product = App\Models\Product::where('vendor_id',$vendor->id)->orderBy('id','DESC')->get();
                                           @endphp         
                                ...
                                <div class="vendor-info mb-30">
                                    <ul class="contact-infor text-muted">
                                        ...
                                        <li><img src="{{asset('backend')}}/assets/imgs/theme/icons/icon-contact.svg" alt="" /><strong>Call Us:</strong><span>{{$vendor->phone}}</span></li>
                                    </ul>
                                </div>
