            ...
            <div class="container">
                <div class="section-title style-2 wow animate__animated animate__fadeIn">
                    ...
                    <ul class="nav nav-tabs links" id="myTab" role="tablist">
                        ...
                        $categories = App\Models\Categories::orderBy('categories_name','ASC')->limit(7)->get();
                        @endphp
                        @foreach($categories  as $cat)
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="nav-tab-two" data-bs-toggle="tab" href="#categoryy{{$cat->id}}" type="button" role="tab" aria-controls="tab-two" aria-selected="false">{{$cat->categories_name}}</a>
                        </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="categoryy{{$cats->id}}" role="tabpanel" aria-labelledby="tab-two">
                        <div class="row product-grid-4">
                @php
                $catWiseProduct = App\Models\Product::where('category_id',$cats->id)->orderBy('id','DESC')->get();
                @endphp
