    ...
    <div class="table-responsive order_table checkout">
                ...
                <div class="form-row">
                    ...
                    Credit or debit card
                        ...
                        <input type="hidden" name="post_code" value="{{$data['shipping_post_code']}}">
...
var stripe = Stripe('pk_test_51OYYE8ErulxAhjeeYxtscE8ZHtz5GqC6vYSv2XDkNsvrJ9bG250Wv41sMNYPA2yZmGF6FWYq9xr1ipg6RdHT0Tck00yElJK6xZ');
