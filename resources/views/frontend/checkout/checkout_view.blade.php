           ...
           <div class="row shipping_calculator">
                                <div class="form-group col-lg-6">
                                    <div class="custom_select">
                                        <select required="" class="form-control select-active" name="division_id">
                                ...
                                <div class="form-group col-lg-6">
                                    <input required="" type="text" value="{{Auth::user()->phone}}"  name="shipping_phone" placeholder="Phone*">
                                </div>
                            </div>
                             ...
                             <div class="row shipping_calculator">
                                <div class="form-group col-lg-6">
                                    <div class="custom_select">
                                        <select  required="" class="form-control select-active" name="district_id">
                  ...
                  <div class="row shipping_calculator">
                                <div class="form-group col-lg-6">
                                    <div class="custom_select">
                                        <select required="" class="form-control select-active" name="state_id">
                                ...
                                <div class="form-group col-lg-6">
                                    <input required="" type="text" name="shipping_address" value="{{Auth::user()->address}}" placeholder="Address *">
                                </div>
                            </div>
    ...
    <div class="table-responsive order_table checkout">
        <table class="table no-border">
            <tbody>
                ...
                <tr>
                    <td class="image product-thumbnail"><img src="{{asset('/frontend_upload/product/thumbnail/'.$item->options->image)}}" alt="#"></td>
                    <td>
 ...
 <table class="table no-border">
                    ...
                    <div class="payment ml-30">
                        ...
                        <div class="payment_option">
                            <div class="custome-radio">
                                <input class="form-check-input" required="" type="radio" name="payment" value="stripe" id="exampleRadios3" checked="">
                            ...
                            <div class="custome-radio">
                                <input class="form-check-input" required="" type="radio" value="cash" name="payment" id="exampleRadios4" checked="">
                                <label class="form-check-label" for="exampleRadios4" data-bs-toggle="collapse" data-target="#checkPayment" aria-controls="checkPayment">Cash on delivery</label>
                            </div>
                            <div class="custome-radio">
                                <input class="form-check-input" required="" value="onlineCash" type="radio" name="payment" id="exampleRadios5" checked="">
                                <label class="form-check-label" for="exampleRadios5" data-bs-toggle="collapse" data-target="#paypal" aria-controls="paypal">Online Getway</label>
                            </div>
                        </div>
                        <div class="payment-logo d-flex">
                            <img class="mr-15" src="{{asset('/backend')}}/assets/imgs/theme/icons/payment-paypal.svg" alt="">
                            <img class="mr-15" src="{{asset('/backend')}}/assets/imgs/theme/icons/payment-visa.svg" alt="">
                            <img class="mr-15" src="{{asset('/backend')}}/assets/imgs/theme/icons/payment-master.svg" alt="">
                            <img src="{{asset('backend')}}/assets/imgs/theme/icons/payment-zapper.svg" alt="">
                        </div>
	...
	$(document).ready(function(){
		$('select[name="division_id"]').on('change',function(){
			...
			if(division_id){
				$.ajax({
					url:"{{('/shipping-districts-ajax/')}}"+division_id,
					type:"GET",
					dataType:'json',
        ...
        $('select[name="district_id"]').on('change',function(){
			...
			if(district_id){
				$.ajax({
					url:"{{('/shipping-state-ajax/')}}"+district_id,
					type:"GET",
					dataType:'json',
					success:function(data){
						$('select[name = "state_id"]').html('');
